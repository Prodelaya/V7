...
from src.subscriptions.infrastructure.repositories.database_manager import DatabaseManager
...
# Constants
DB_PATH = "bot_data.db"
WELCOME_GIF_PATH = "src/subscriptions/infrastructure/telegram/media/welcome_glitch.gif"
