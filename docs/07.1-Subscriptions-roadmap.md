...
| 5B.5 | Implementar check explícito de aceptación de T&C antes del checkout (User Request) |
| 5B.6 | Asegurar captura robusta de Telegram User ID en flujo de contratación (User Request) |
